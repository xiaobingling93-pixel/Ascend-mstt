...
work_path = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.realpath(__file__))))))))
...
class TestOperatorDispatchAnalyzer(unittest.TestCase):
    ...
    def test_ops_dispatch_make_render(self):
        ...
        event_dataset = op_dispatch.get_first_data_by_key(op_dispatch.dataset_list, TimelineEventDataset.get_key())
