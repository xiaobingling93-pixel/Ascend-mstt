...
from atat.core.data_dump.data_processor.base import BaseDataProcessor, TensorStatInfo
...
from atat.mindspore.dump.hook_cell.wrap_functional import ops_func, mint_ops_func
...
class MindsporeDataProcessor(BaseDataProcessor):
    ...
    def analyze_dtype_in_kwargs(element):
        single_arg = {}
        single_arg.update({"type": "mindspore.dtype"})
