...
MindStudio精度调试工具（MindStudio accuracy debugger），简称msad，是ATT工具链下精度调试部分的工具包。主要包括精度预检和精度比对等子工具，当前适配场景包括PyTorch和MindSpore。
...
1. whl包获取。
   ...
   | ----- | ---------- | ------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
   | 0.0.2 | 2024-05-23 | 1.11.0/2.0/2.1/2.2 | [ascend_training_accuracy_tools-0.0.2-py3-none-any.whl](https://ptdbg.obs.myhuaweicloud.com/att/0.0/ascend_training_accuracy_tools-0.0.2-py3-none-any.whl) |                                                              |
...
安装msad工具后，可以按照如下思路选择合适的子工具进行精度调试：
...
上述流程中的工具均为msad工具的子工具，使用相同的命令行，格式如下：
