...
class MSComparator(Comparator):
    ...
    def get_api_name(self, api_list):
        if len(api_list) > 2:
            ...
            logger.error("Failed to retrieve API name, please check if the downloaded data is reasonable")
            raise Exception("Failed to retrieve API name, please check if the downloaded data is reasonable")
