...
class TestBaseHookManager(unittest.TestCase):
    ...
    def test_should_execute_hook_conditions(self):
        ...
        self.assertTrue(self.manager._should_execute_hook(Const.MODULE, module, True))
        self.assertTrue(self.manager._should_execute_hook(Const.API, module, False))
        
        Runtime.is_running = False
        self.assertFalse(self.manager._should_execute_hook(Const.MODULE, module, True))
        
        Runtime.is_running = True
        module.forward_data_collected = False
        self.assertFalse(self.manager._should_execute_hook(Const.API, module, False))
        ...
        BaseHookManager.inner_switch = False
        self.assertFalse(self.manager._should_execute_hook(Const.MODULE, module, True))
        self.assertFalse(self.manager._should_execute_hook(Const.API, module, True))
