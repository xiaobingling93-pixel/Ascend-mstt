...
class TestLayerMapping(unittest.TestCase):
    ...
    def test_generate_api_mapping_by_layer_mapping_then_pass(self):
        ...
        excepted_api_mapping = {
            ...
            "Cell.network_with_loss.module.language_model.encoder.layers.0.ParallelTransformerLayer.backward.0": "Module.module.module.language_model.encoder.layers.0.ParallelTransformerLayer.forward.0",
            "Cell.network_with_loss.module.language_model.encoder.layers.0.input_norm.FusedRMSNorm.backward.0": "Module.module.module.language_model.encoder.layers.0.input_norm.RMSNorm.forward.0",
    ...
    def test_generate_data_mapping_by_layer_mapping_then_pass(self):
        ...
        excepted_data_mapping = {
            ...
            "Cell.network_with_loss.module.language_model.encoder.layers.0.ParallelTransformerLayer.backward.0.input.0": "Module.module.module.language_model.encoder.layers.0.ParallelTransformerLayer.forward.0.input.0",
            "Cell.network_with_loss.module.language_model.encoder.layers.0.ParallelTransformerLayer.backward.0.output.0": "Module.module.module.language_model.encoder.layers.0.ParallelTransformerLayer.forward.0.output.0",
            "Cell.network_with_loss.module.language_model.encoder.layers.0.input_norm.FusedRMSNorm.backward.0.input.0": "Module.module.module.language_model.encoder.layers.0.input_norm.RMSNorm.forward.0.input.0",
            "Cell.network_with_loss.module.language_model.encoder.layers.0.input_norm.FusedRMSNorm.backward.0.output.0": "Module.module.module.language_model.encoder.layers.0.input_norm.RMSNorm.forward.0.output.0",
