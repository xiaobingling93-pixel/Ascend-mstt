...
class TestApiAccuracyChecker(unittest.TestCase):
    ...
    def test_statistics_mode(self):
        ...
        # 初始化 Args 类，提供三个路径参数
        args = Args(api_info_file=api_info_statistics_path, out_path=result_directory)  # 您可以在这里传入自定义的路径参数
    ...
    def test_tensor_mode(self):
        ...
        # 初始化 Args 类，提供三个路径参数
        args = Args(api_info_file=api_info_tensor_path, out_path=result_directory)  # 您可以在这里传入自定义的路径参数
