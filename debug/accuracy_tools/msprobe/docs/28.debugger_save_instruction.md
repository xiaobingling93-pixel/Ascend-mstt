...
｜ step    |   指定采集某个 step 的数据，list[Union[int, str]] 类型。细节详见[通用配置说明](./02.config_introduction.md#11-通用配置)  | 否       |
| async_dump        | 异步 dump 开关，bool 类型。细节详见[通用配置说明](./02.config_introduction.md#11-通用配置)  | 否       |
