...
参见 [pytorch精度采集](./05.data_dump_PyTorch.md)。
...
| 参数                 | 说明                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
|--------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| -i 或 --input_path  | dump数据的目录，层级为step。如对于目录结构<br/>/xxx/dump: {<br/> &emsp; step0: {<br/> &emsp; &emsp; rank0: \[<br/> &emsp; &emsp; &emsp; dump.json, construct.json, stack.json<br/> &emsp; &emsp; \], <br/> &emsp; &emsp; rank1: \[<br/> &emsp; &emsp; &emsp; dump.json, construct.json, stack.json<br/> &emsp; &emsp; \], <br/> &emsp; &emsp; rank2: \[<br/> &emsp; &emsp; &emsp; dump.json, construct.json, stack.json<br/> &emsp; &emsp; \], <br/> &emsp; &emsp; rank3: \[<br/> &emsp; &emsp; &emsp; dump.json, construct.json, stack.json<br/> &emsp; &emsp; \] <br/> &emsp; }<br/>} <br/> dump_step_path为 \"/xxx/dump/step0/" |
