...
{cell_name}.{class_name}从dump cell模块级.npy文件名获取，命名格式为：`{Cell}.{cell_name}.{class_name}.{forward/backward/parameters_grad}.({index}.{input/output}.){参数/序号}`

{module_name}.{class_name}从dump module模块级.npy文件名获取，命名格式为：`{Module}.{module_name}.{class_name}.{forward/backward/parameters_grad}.({index}.{input/output}.){参数/序号}`
...
# 模块
{Cell}.{cell_name}.{class_name}.{forward/backward/parameters_grad}.({index}.{input/output}.){参数/序号}: {Module}.{module_name}.{class_name}.{forward/backward/parameters_grad}.({index}.{input/output}.){参数/序号}
```
