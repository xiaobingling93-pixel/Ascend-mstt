...
1. 创建配置文件config.json，样例如下：
   ...
   **bounds和值分布解释**
   ...
   ![Alt text](./figures/grad_probe_image-1.png)
...
![Alt text](./figures/grad_probe_image.png)
...
![Alt text](./figures/grad_probe_image-3.png)

- 第3步相似度下降超过0.03

![Alt text](./figures/grad_probe_image-4.png)

- 正常情况

![Alt text](./figures/grad_probe_image-2.png)
