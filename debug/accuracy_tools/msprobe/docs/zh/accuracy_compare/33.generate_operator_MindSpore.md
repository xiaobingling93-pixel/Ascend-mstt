...
### 前提
1. 安装 msprobe。详见[ msprobe 安装](../msprobe_install_guide.md)章节。
2. 已完成对训练过程的dump，获得dump.json文件。
    [MindSpore 场景下的数据采集](../dump/mindspore_data_dump_instruct.md)章节或[Msadapter 场景下的数据采集](../dump/msadapter_data_dump_instruct.md)章节，注意需要配置 level="L1"。
