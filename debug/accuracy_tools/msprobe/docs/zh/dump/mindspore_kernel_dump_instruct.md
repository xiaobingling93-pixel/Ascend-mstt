...
本文主要介绍 kernel dump 的配置示例和采集结果介绍， msprobe 数据采集功能的详细使用参考 《[MindSpore 场景的精度数据采集](./mindspore_data_dump_instruct.md)》。
...
│  ...
```
成功采集到数据后，可以使用 msprobe 工具提供的《[PyTorch 场景的数据解析](../other_functions/14.data_parse_PyTorch.md)》功能分析数据。
