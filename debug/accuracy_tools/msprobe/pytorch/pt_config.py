...
class RunUTConfig(BaseConfig):
    ...
    def __init__(self, json_config):
        ...
        self.is_online = json_config.get("is_online", Const.IS_ONLINE)
        self.nfs_path = json_config.get("nfs_path", Const.NFS_PATH)
        self.is_benchmark_device = json_config.get("is_benchmark_device", Const.IS_BENCHMARK_DEVICE)
        self.host = json_config.get("host", "")
        self.port = json_config.get("port", -1)
