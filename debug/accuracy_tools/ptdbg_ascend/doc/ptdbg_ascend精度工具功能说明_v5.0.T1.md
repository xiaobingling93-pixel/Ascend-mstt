...
```bash
# 传入待比对数据目录
Parse >>> cad -m ./my_dump_path
......
# 比对结果打印
[INFO] The comparison result have been written to "./parse_data/acl_batch_convert".
[INFO] The command was completed and took 10 seconds.
[INFO] Convert finished!!
```
...
......
# 比对结果打印
[INFO] The comparison result have been written to "./parse_data/acl_batch_comapre/result_20240124123542.csv".
