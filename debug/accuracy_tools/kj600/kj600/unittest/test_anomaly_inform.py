...
class TestAnomalyInform(unittest.TestCase):
    ...
    def test_email_inform(self):
        inform_args = {"inform": {"recipient": "email", "send_email_address": "xueyuqing@huawei.com", "receive_email_address": "xueyuqing@huawei.com",
                                  "send_email_username": "x30021831", "send_email_password": "********",
