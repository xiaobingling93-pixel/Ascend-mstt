...
3. [advisor](https://gitee.com/ascend/mstt/blob/master/profiler/advisor)

   将Ascend PyTorch Profiler或者msprof采集的PyThon场景性能数据进行分析，并输出性能调优建议。

4. [bind_core](https://gitee.com/ascend/mstt/blob/master/profiler/affinity_cpu_bind)
