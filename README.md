...
MindStudio训练场景工具链聚焦您在模型迁移、模型开发中遇到的痛点问题，提供全流程的工具链，通过提供分析迁移工具、精度调试工具、性能调优工具三大主力工具包，帮助您解决开发过程中迁移困难、Loss跑飞、性能不达标或劣化等问题，让您轻松解决精度和性能问题，开启乐趣十足的极简开发之旅。
...
[MindStudio Probe（msprobe，MindStudio 精度调试工具）](https://gitcode.com/cai-weiwei1989/mstt_1/tree/master/debug/accuracy_tools/msprobe)。

基于采集的精度数据进行分析，识别AI作业中的精度问题。

### 性能工具

- [msprof-analyze（MindStudio Profiler Analyze 性能分析工具）](https://gitcode.com/cai-weiwei1989/mstt_1/tree/master/profiler/msprof_analyze/)

  基于采集的性能数据进行分析，识别AI作业中的性能瓶颈。

- [bind_core](https://gitcode.com/cai-weiwei1989/mstt_1/tree/master/profiler/affinity_cpu_bind)

  绑核脚本，支持非侵入修改工程代码，实现一键式绑核功能。

- [msMonitor](https://gitcode.com/cai-weiwei1989/mstt_1/tree/master/msmonitor)

  MindStudio一站式在线监控工具。

### Tensorboard

Tensorboard支持模型结构进行分级可视化展示的插件tb-graph-ascend，具体请参见[tb_graph_ascend](plugins/tensorboard-plugins/tb_graph_ascend)。
