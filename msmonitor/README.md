...
| msmonitor_plugin-{mindstudio_version}-cp{version}-cp{version}-linux_{system_architecture}64.whl | MSPTI Monitor、IPC等公共能力工具包，{mindstudio_version}表示mindstudio版本号，{version}表示python版本号，{system_architecture}表示CPU架构系统 |
...
### Step 2: 运行
npumonitor和nputrace功能详细说明请参考[npumonitor](./docs/npumonitor.md)或[nputrace](./docs/nputrace.md)特性介绍章节，下面介绍msMonitor常见的使用场景：
