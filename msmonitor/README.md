...
| msmonitor_plugin-0.1-cp{version}-cp{version}-linux_aarch64.whl | MSPTI Monitor、IPC等公共能力工具包，{version}表示python版本号 |
...
dyno --certs-dir /home/client_certs npu-monitor --report-interval-s 30 --mspti-activity-kind Kernel
```
