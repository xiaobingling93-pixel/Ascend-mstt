...
export function updateUrlDict(dict: StringDict): void {
  urlDict = dict;
}
 ...
 */
export function writeComponent(component: string, useLocationReplace = false): void {
  if (useHash()) {
 ...
 */
export function unsetFromURI(key, useLocationReplace = false): void {
